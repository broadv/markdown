...
# 查看pool状态
```
root@ceph-tal-osd7:/mnt/sdz# ceph osd pool stats
pool cephfs-metadata id 1
  client io 5.9 KiB/s wr, 0 op/s rd, 3 op/s wr

pool cephfs-data id 2
  client io 25 KiB/s wr, 0 op/s rd, 0 op/s wr

pool cephfs-tier id 3
  nothing is going on
```
